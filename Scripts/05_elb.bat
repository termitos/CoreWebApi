...
echo 'Target group'
aws elbv2 create-target-group --name corewebapi-tg --port 8080 --protocol TCP --target-type ip --vpc-id vpc-0352eb5dcafe265e5 --health-check-interval-seconds 10 --health-check-path / --health-check-protocol HTTP --healthy-threshold-count 3 --unhealthy-threshold-count 3
